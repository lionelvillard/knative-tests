...
import (
	...
	"github.com/knative-tests/pkg/installer"

	"github.com/knative-tests/pkg/manifest"
...
func (c *resourceContextImpl) KoApply(dir, filename string) {
	c.Helper()

	// TODO: namespace!

	output, err := installer.KoApply(dir, filename)
	if err != nil {
		c.Fatal(output)
	}
}
